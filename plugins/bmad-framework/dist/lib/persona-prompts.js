 ...
 */
export function getPersonaPrompt(role) {
    const prompts = {
 ...
 */
function getMasterPersonaPrompt() {
 ...
 */
function getScrumMasterPersonaPrompt() {
 ...
 */
function getArchitectPersonaPrompt() {
 ...
 */
export function getPersonaDescription(role) {
    const descriptions = {
 ...
 */
export function getPersonaActivePhases(role) {
    const allPhases = ['brainstorming', 'architecture', 'development', 'testing'];
    const rolePhases = {
        master: allPhases,
